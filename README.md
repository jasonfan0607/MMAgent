...
完整的项目文档集中在 [`docs/md/`](./docs/md/README.md)，覆盖架构、Agent 协同、API、Prompt 设计、部署与开发：

| 文档 | 用途 |
| --- | --- |
| [总览](./docs/md/overview.md) | 5 分钟了解项目愿景、能力、技术栈 |
| [总体架构](./docs/md/architecture.md) | 分层、模块、数据流、关键设计决策 |
| [前端架构](./docs/md/frontend-architecture.md) | Vue 3 + shadcn-vue + Pinia 工程详解 |
| [后端架构](./docs/md/backend-architecture.md) | FastAPI + Agentless Workflow + Redis |
| [多 Agent 协同](./docs/md/multi-agent.md) | 四个 Agent 的分工、契约、容错 |
| [工作流](./docs/md/workflow.md) | 端到端时序图，每一步发生了什么 |
| [API 规范](./docs/md/api.md) | REST + WebSocket 接口字段说明 |
| [Prompt 设计](./docs/md/prompts.md) | 四个 Agent 的系统提示词剖析 |
| [部署](./docs/md/deployment.md) | Docker / 本地 / 云端部署手册 |
| [开发指南](./docs/md/development.md) | 约定、调试、扩展清单 |

> 想快速跳转：先看 [`docs/md/README.md`](./docs/md/README.md) 文档导览。
